...
function MobileMenu({openMenu, setOpenMenu}) {
  return (
    <div className={`md:hidden w-full h-screen bg-[rgb(114,221,247)] fixed top-0 z-40 ${openMenu ? 'translate-x-0 opacity-100' : 'translate-x-full opacity-0'} transition-all duration-500`}>
      <div className="pt-[100px] px-5 flex flex-col gap-7.5">
        <nav>
          <ul className="flex flex-col font-space font-bold uppercase">
            <li className="py-4.5">
              <a onClick={() => setOpenMenu(prev => !prev)} href="#about" className="text-[2rem]/[1]">About</a>
            </li>
            <li className="py-4.5">
              <a onClick={() => setOpenMenu(prev => !prev)} href="#team" className="text-[2rem]/[1]">Team</a>
            </li>
            <li className="py-4.5">
              <a onClick={() => setOpenMenu(prev => !prev)} href="#coin" className="text-[2rem]/[1]">Coin</a>
            </li>
            <li className="py-4.5">
              <a onClick={() => setOpenMenu(prev => !prev)} href="#follow-us" className="text-[2rem]/[1]">Follow Us</a>
            </li>
          </ul>
        </nav>

        <span className="font-space font-bold flex">
          <Button text="MINT NFT" className='max-md:-translate-[3px] max-md:group-hover:translate-[3px] max-md:text-[1.2rem]/[1] max-md:px-5 max-md:py-[15px] max-md:h-full' className2='max-md:h-full'/>
        </span>

        <div className="w-full">
          <ul className="mr-2 flex gap-4 justify-start">
